...
CREATE TABLE "Student" (
    ...
    "sex" "UserSex" NOT NULL DEFAULT 'MALE',
...
-- AddForeignKey
ALTER TABLE "Announcements" ADD CONSTRAINT "Announcement_classId_fkey" FOREIGN KEY ("classId") REFERENCES "Class"("id") ON DELETE SET NULL ON UPDATE CASCADE;
